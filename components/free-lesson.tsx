      ...
      <div className="mx-auto max-w-5xl">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] border-2 border-foreground bg-neon p-7 text-neon-foreground shadow-[8px_8px_0_0_var(--foreground)] md:p-12">
            ...
            <p className="font-hand text-3xl">это не экзамен →</p>
            ...
            <ul className="mt-8 grid gap-3 sm:grid-cols-2">
              {points.map((p, i) => (
                <Reveal key={i} delay={i * 0.07} from="up">
                  <li className="flex items-start gap-3 rounded-xl border-2 border-neon-foreground/30 bg-neon-foreground/10 p-4">
